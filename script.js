document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatedElements.length > 0) {
    // Add base styles via class if not already present
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יהב ברזני ליווי חיילים משוחררים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0818c663-1ec2-4bfd-a412-de3591270f79',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0818c663-1ec2-4bfd-a412-de3591270f79';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0818c663-1ec2-4bfd-a412-de3591270f79';
